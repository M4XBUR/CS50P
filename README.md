...
**4.Libraries** - Modules. random. import. from. statistics. Command-Line Arguments. sys. sys.argv. IndexError. sys.exit. **5.Unit Tests** - Slices. Packages. PyPI. pip. cowsay. APIs. requests. JSON. \__name__.  
